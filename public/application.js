...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addMovie = function addMovie(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.addAMovie(data).then(function (data) {
	    ...
	    // $('.deleted').hide()
	    getAllMovies();
	  }).then(ui.addMovieSuccess).catch(ui.addMovieFailure);
	};

	var deleteMovie = function deleteMovie(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.deleteAMovie(data).then(function (data) {
	    $('.form-clear').trigger('reset');
	    ...
	    // $('.deleted').show()
	    getAllMovies();
	  }).then(ui.deleteMovieSuccess).catch(ui.deleteMovieFailure);
	};

	var updateRating = function updateRating(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.updateARating(data).then(function (data) {
	    $('.form-clear').trigger('reset');
	    ...
	    // $('.deleted').hide()
	    getAllMovies();
	  }).then(ui.updateRatingSuccess).catch(ui.updateRatingFailure);
	};

	var getAllMovies = function getAllMovies() {
	  // event.preventDefault()
	  api.requestAllMovies().then(ui.allMoviesSuccess).catch(ui.allMovieFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var requestAllMovies = function requestAllMovies(data) {
	  return $.ajax({
	...
	var deleteAMovie = function deleteAMovie(data) {
	  return $.ajax({
	...
	var addAMovie = function addAMovie(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/movies',
	    method: 'POST',
	    headers: {
	...
	var updateARating = function updateARating(movie) {
	  var data = movie;
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var displayMoviesTemplate = __webpack_require__(12);
	...
	var passwordChangeFailure = function passwordChangeFailure(error) {
	...
	var allMoviesSuccess = function allMoviesSuccess(data) {
	  store.movie = data.movie;
	  var displayMoviesHTML = displayMoviesTemplate({ movies: data.movies });
	  $('.display-list').show();
	  $('.display-list').empty();
	  $('.display').show();
	...
	var allMoviesFailure = function allMoviesFailure(error) {
	  $('.instructions').text('Oops, something went wrong.', error).fadeIn('fast').delay(2000).fadeOut('slow');
	};

	var deleteMovieSuccess = function deleteMovieSuccess() {
	...
	var addMovieSuccess = function addMovieSuccess() {
	  $('.instructions').empty();
	...
	var addMovieFailure = function addMovieFailure(error) {
	...
	var updateRatingFailure = function updateRatingFailure(error) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.movies : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "<!-- <div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "926ae55755f0bf097bb0b7f20a5e567f.jpg";
